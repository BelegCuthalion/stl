...
\begin{lem}\label{lem:l-box-nabla} $\mathbf{LDL}_{/\rightarrow}(\star) \vdash A \Rightarrow \top \rightsquigarrow \nabla A$.
\end{lem}
\begin{proof}\quad
	\begin{prooftree}
		\AXC{}
...
\begin{lem}\label{lem:l-nabla-dist-or} $\mathbf{LDL}_{/\rightarrow}(\star) \vdash \nabla (A \lor B) \Rightarrow \nabla A \lor \nabla B$.
\end{lem}
...
\begin{lem}\label{lem:l-nabla-n-bot} For $n > 0$, $\mathbf{LDL}_{/\rightarrow}(\star) \vdash \nabla^n \bot \Rightarrow \bot$.
\end{lem}
...
\begin{lem}\label{lem:l-nabla-dist-si} For any $n \ge 0$, $\mathbf{LDL}_{/\rightarrow}(\star) \vdash \nabla^n (A \rightsquigarrow B) \Rightarrow \nabla^n A \rightsquigarrow \nabla^n B$.
\end{lem}
\begin{proof}\quad
	\begin{prooftree}
		\AXC{}
